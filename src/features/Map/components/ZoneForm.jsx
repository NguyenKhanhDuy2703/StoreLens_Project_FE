...
const ZoneForm = ({ zone, isEditing, onSave, onCancel, onChange }) => (
  <div className="mt-4 bg-gradient-to-r from-purple-50 to-blue-50 p-4 rounded-lg border-2 border-purple-300">
    ...
    <div className="space-y-3">
      <div>
        <label className="block text-sm font-medium mb-1">Tên Zone</label>
        <input
          type="text"
          placeholder="VD: Khu vực lối vào"
          value={zone.name}
      ...
      <div>
        <label className="block text-sm font-medium mb-1">Label (phân loại)</label>
        <input
          type="text"
      ...
      <div className="flex space-x-2">
        <button
          onClick={onSave}
          disabled={!zone.name || !zone.labelName}
