import { Rect, Group, Line, Image, Circle, Text } from "react-konva";
...
export const HeatmapGrid = ({ matrix, gridSize, frameWidth, frameHeight, opacity  }) => {
  const groupRef = useRef(null);
  console.log("Opacity in HeatmapGrid:", opacity);
  ...
  useEffect(() => {
    ...
    if (node && frameWidth > 0 && frameHeight > 0) {
      node.clearCache();
      const padding = 30; 
      try {
        node.cache({
